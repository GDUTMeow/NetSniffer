        ...
        try:
            ...
            if first_line.startswith('HTTP/'):
                ...
                try:
                    ...
                    version = None
                    logger.warning(
                        f'Unknown HTTP version: {line_content[0]}, unable to parse HTTP packet.'
                    )
                    return None
                ...
                try:
                    ...
                    logger.warning(
                        f'Unknown HTTP method: {line_content[0]}, unable to parse HTTP packet.'
                    )
                    return None
                path = line_content[1]
                try:
                    ...
                    version = None
                    logger.warning(
                        f'Unknown HTTP version: {line_content[2]}, unable to parse HTTP packet.'
                    )
                    return None
